...
echo rxEnable_pullNone > /sys/devices/ocp.2/gpio-P9.15_gpio48.14/state
echo rxEnable_pullNone > /sys/devices/ocp.2/gpio-P9.17_gpio4.15/state
echo rxEnable_pullNone > /sys/devices/ocp.2/gpio-P9.18_gpio5.16/state
echo rxEnable_pullNone > /sys/devices/ocp.2/gpio-P9.22_gpio2.17/state
